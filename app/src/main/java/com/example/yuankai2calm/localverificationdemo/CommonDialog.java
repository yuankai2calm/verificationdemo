...
public class CommonDialog extends Dialog{
    ...
    protected void init(final Context context){
        ...
        barDivider = content.findViewById(R.id.v_button_bar_divider);
        buttonDivider = content.findViewById(R.id.v_button_divider);
        positiveButton = (Button)content.findViewById(R.id.positive_bt);
        negativeButton = (Button)content.findViewById(R.id.negative_bt);
